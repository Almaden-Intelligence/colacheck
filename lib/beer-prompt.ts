...
12. **Government Health Warning** — under 27 CFR Part 16, whose full text is supplied above. Check the wording, the capitalisation of the first two words, and the type size threshold for the container size shown.
...
15. **Type Size** — ALWAYS "review", never "pass". See the MEASURED TYPE SIZE section below. Give the applicable threshold for the container size shown, taken from the regulation text. Do not infer size from proportions, do not say text "appears adequate", and do not pass this check because the label looks normal.
