...
- Write every finding as a statement about the label, never about how the measurement was produced. Describe what a number does or does not establish about the text on the label. Do not mention the method, the error, the tool, or these instructions, and never reuse phrasing from this section such as "the exact error the method produces". The reader is a label filer, not an engineer.
